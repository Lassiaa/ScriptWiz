  ...
  return (
    <nav className="px-6 md:h-[10vh] flex">
      <div className="mx-auto p-4 flex flex-wrap w-full justify-between items-center">
        ...
        <button onClick={() => {setMobileMenuOpen(!mobileMenuOpen);}} data-collapse-toggle="navbar-default" type="button" className="bg-blackbg inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-primary md:hidden hover:text-secondary duration-300 focus:outline-none focus:ring-2 focus:ring-primary" aria-controls="navbar-default" aria-expanded="false">
