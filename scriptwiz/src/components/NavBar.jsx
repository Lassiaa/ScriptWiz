    ...
    <nav className="bg-white border-gray-200 dark:bg-gray-900">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <NavLink to="/" className="flex items-center space-x-3 rtl:space-x-reverse">
          ...
          <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">ScriptWiz</span>
        </NavLink>
          ...
          <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <NavLink
                to="/overview"
                className={({ isActive }) =>
                  `flex py-2 px-3 rounded md:p-0 dark:text-white ${isActive ? 'text-blue-700 bg-gray-100 md:bg-transparent md:text-blue-700 md:dark:text-blue-500 dark:bg-gray-700' : 'text-gray-900 hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent'}`
                }
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 mr-2">
                  <path fillRule="evenodd" d="M2.25 2.25a.75.75 0 0 0 0 1.5H3v10.5a3 3 0 0 0 3 3h1.21l-1.172 3.513a.75.75 0 0 0 1.424.474l.329-.987h8.418l.33.987a.75.75 0 0 0 1.422-.474l-1.17-3.513H18a3 3 0 0 0 3-3V3.75h.75a.75.75 0 0 0 0-1.5H2.25Zm6.04 16.5.5-1.5h6.42l.5 1.5H8.29Zm7.46-12a.75.75 0 0 0-1.5 0v6a.75.75 0 0 0 1.5 0v-6Zm-3 2.25a.75.75 0 0 0-1.5 0v3.75a.75.75 0 0 0 1.5 0V9Zm-3 2.25a.75.75 0 0 0-1.5 0v1.5a.75.75 0 0 0 1.5 0v-1.5Z" clipRule="evenodd" />
                </svg>
                <span className="self-center whitespace-nowrap dark:text-white">Overview</span>
              </NavLink>
            </li>
            <li>
              ...
              >
                ...
                <span className="self-center whitespace-nowrap dark:text-white">Schedule</span>
              </NavLink>
            </li>
            <li>
              <NavLink
              ...
              >
                ...
                <span className="self-center whitespace-nowrap dark:text-white">Characters</span>
              </NavLink>
            </li>
            <li>
              <NavLink
              ...
              >
                ...
                <span className="self-center whitespace-nowrap dark:text-white">Tags</span>
              </NavLink>
            </li>
            <li>
              <NavLink
              ...
              >
                ...
                <span className="self-center whitespace-nowrap dark:text-white">New Script</span>
              </NavLink>
            </li>
          </ul>
        </div>
